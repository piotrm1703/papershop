<div class="shoppingCart">
    ...
    <img src= "<?php echo htmlEscape($cartProduct->img) ?>" class="imgView"><br><br>
    &nbsp;&nbsp;<p class="price"><b>Suma: </b><?php echo htmlEscape($productSum)?>  zł  &nbsp;&nbsp;<b>Ilość:</b><?php echo htmlEscape($productQuantity) ?></p>
